...
- [ ] T010 Define event contracts (telemetry/commands/ACK) and topic conventions
- [ ] T011 Implement audit persistence for telemetry, commands, ACKs, and alarms
- [ ] T012 Implement idempotency keys/guards for duplicate event processing
- [ ] T013 Implement hysteresis-ready state transition scaffolding
...
- [ ] T016 [P] [US1] Test critical threshold triggers command emission and ACK capture
- [ ] T017 [P] [US1] Test duplicate message handling keeps state consistent
...
- [ ] T023 [US1] Add structured audit logging for user story 1 operations
...
- Include explicit tasks for event contracts, idempotency, and hysteresis when relevant
